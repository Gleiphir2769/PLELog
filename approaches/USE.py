...
from representations.templates.statistics import Simple_template_TF_IDF, Template_TF_IDF_without_clean, Template_USE
...
def get_sentence_embedding():
    # Load the Universal Sentence Encoder's TF Hub model
