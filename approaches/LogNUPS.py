...
from label_utils.pseudo_labeling_util import pseudo_labeling
...
if __name__ == '__main__':
    ...
    # for auto-label
    argparser.add_argument('--out', default=f'outputs', help='directory to output the result')
    argparser.add_argument('--temp-nl', default=2.0, type=float,
                        help='temperature for generating negative pseduo-labels, default 2.0')
    argparser.add_argument('--tau-p', default=0.70, type=float,
                        help='confidece threshold for positive pseudo-labels, default 0.70')
    argparser.add_argument('--tau-n', default=0.05, type=float,
                        help='confidece threshold for negative pseudo-labels, default 0.05')
    argparser.add_argument('--no-uncertainty', action='store_true',
                        help='use uncertainty in the pesudo-label selection, default true')
    argparser.add_argument('--kappa-p', default=0.05, type=float,
                        help='uncertainty threshold for positive pseudo-labels, default 0.05')
    argparser.add_argument('--kappa-n', default=0.005, type=float,
    ...
    argparser.add_argument('--dropout', default=0.3, type=float,
                        help='dropout probs')
    argparser.add_argument('--num-classes', default=10, type=int,
                        help='total classes')
    argparser.add_argument('--class-blnc', default=10, type=int,
    ...
    label_generator.correct_pseudo_label(labeled_train)
