...
class OpenStackLoader(BasicDataLoader):
    def __init__(self, in_file=None, datasets_base=os.path.join(PROJECT_ROOT, 'datasets/OpenStack'),
        ...
        file_handler = logging.FileHandler(os.path.join(LOG_ROOT, 'OpenStackLoader.log'))
